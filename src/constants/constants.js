...
export const category = [
  ...
  { name: "NextJs", icon: <ZoomInMapTwoTone /> },
  { name: "GitHub", icon: <ZoomInMapTwoTone /> },
  { name: "Bootstrap", icon: <ZoomInMapTwoTone /> },
  { name: "ReactJs", icon: <ZoomInMapTwoTone /> },
  { name: "MySql", icon: <ZoomInMapTwoTone /> },
  { name: "NodeJs", icon: <ZoomInMapTwoTone /> },
  { name: "Flutter", icon: <ZoomInMapTwoTone /> },
];
